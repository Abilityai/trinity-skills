#!/usr/bin/env python3
"""
Generate images using Gemini 3.1 Flash Image API (Nano Banana 2) with configurable options.
...
def generate_image(prompt: str, output_path: str, aspect_ratio: str = "1:1") -> bool:
    """Generate an image with the Gemini 3.1 Flash Image model (Nano Banana 2).
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate images using Gemini 3.1 Flash Image (Nano Banana 2)",
