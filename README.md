...
| `add-orchestrator` | 1.20 | mirrored · abilities | Make any agent a system-aware orchestrator — installs /discover-agents (discover the fleet from live Trinity and/or a repo list into a descr |
...
| `create-playbook` | 2.15 | mirrored · abilities | Create a new skill or playbook |
