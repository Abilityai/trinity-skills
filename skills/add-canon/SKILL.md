...
user-invocable: true
deprecated: true
superseded-by: "canon-publish — Abilityai/tandem-skill-library (private; not reachable from this public catalog)"
metadata:
  version: "1.7"
  created: 2026-07-28
  author: Ability.ai
  changelog:
    - "1.7: RETIRED from the public library (2026-09-24) — its 4 runtime skills (canon-publish, canon-consume, canon-reconcile, canon-doctor) now live in Abilityai/tandem-skill-library, a private second skills-library source (operator ruling 2026-09-23/24: a deployed agent's ongoing skill diet comes from a library, never a marketplace plugin install). That successor is Ability.ai-internal and not reachable from this public catalog — an external user who needs the canon layer still has the abilities marketplace installer (Abilityai/abilities, unaffected by this retirement) as a local, one-time scaffold. This entry is no longer mirrored from abilities and will be removed at the next minor tag."
